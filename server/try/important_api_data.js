...
'cable cross-over lateral pulldown',
  ...
  const randomTitlePick =[ 'jack burpee',
  'ez barbell anti gravity press',
  'ez bar seated close grip concentration curl',
  'glute-ham raise',
  'hanging straight twisting leg hip raise',
  ...
  'dumbbell bicep curl on exercise ball with leg raised',
  'ez-barbell standing wide grip biceps curl',
  'dumbbell finger curls', 'front plank with twist',
  'band concentration curl',
  'inverted row on bench',
  'dumbbell close-grip press',]

  // for(let i = 0; i < 216; i++){
  //   const randomNum = Math.floor(Math.random() *341)
  //   randomTitlePick.push(allTitles[randomNum])
  // }

  // console.log(randomTitlePick.length)
